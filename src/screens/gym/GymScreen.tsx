...
type GymScreenNavigationProp = StackNavigationProp<RootStackParamList, "Gym">;
      ...
      <ScrollView style={styles.contentContainer}>
        ...
        <View style={styles.infoCard}>
          ...
          <Text style={styles.infoText}>
            Registra tus entrenamientos de fuerza, crea rutinas personalizadas
            y sigue tu progreso con pesos y repeticiones.
          </Text>
        </View>
        ...
        <View style={styles.actionButtonsContainer}>
          ...
          >
            <MaterialIcons name="list-alt" size={24} color={GYM_COLOR} />
