/**
 * Pantalla de Historial de Cardio
 * FITUP - Exercise App
 */
...
import { getUserWorkouts } from "../../services/cardioService";
...
interface CardioHistoryScreenProps {
  navigation: any;
}

const CardioHistoryScreen: React.FC<CardioHistoryScreenProps> = ({ navigation }) => {
  const { user } = useAuth();
    ...
    return (
      <TouchableOpacity style={styles.workoutCard} activeOpacity={0.7}>
        ...
        <View style={styles.cardHeader}>
          <View style={styles.cardHeaderLeft}>
            <View style={styles.iconContainer}>
              <FontAwesome5 name="running" size={20} color={COLORS.cardio} />
            </View>
            <View>
              <Text style={styles.workoutType}>Carrera Libre</Text>
        ...
        <View style={styles.metricsRow}>
          ...
          <View style={styles.metricItem}>
            <Text style={styles.metricValue}>{paceFormatted.formatted}</Text>
  ...
  const renderEmptyList = () => (
    <View style={styles.emptyContainer}>
      <FontAwesome5 name="running" size={60} color={COLORS.textSecondary} />
      <Text style={styles.emptyTitle}>Sin entrenamientos</Text>
      <Text style={styles.emptySubtitle}>
        Aún no has registrado ninguna carrera.{"\n"}¡Comienza tu primera carrera!
      </Text>
      <TouchableOpacity 
        style={styles.startButton}
        onPress={() => navigation.navigate("FreeRun")}
      >
        <MaterialIcons name="play-arrow" size={24} color="white" />
        <Text style={styles.startButtonText}>Iniciar Carrera</Text>
      </TouchableOpacity>
    </View>
  );
...
const styles = StyleSheet.create({
  ...
  iconContainer: {
    ...
    height: 40,
    borderRadius: 20,
    backgroundColor: `${COLORS.cardio}15`,
    justifyContent: "center",
    alignItems: "center",
    marginRight: 12,
  },
...
export default CardioHistoryScreen;